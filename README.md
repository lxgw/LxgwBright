>[!IMPORTANT]
> - 本字体**不适用于**竖向排版。
> - 对于等宽（monospaced）版本，拟搭配 [Monaspace Argon](https://github.com/githubnext/monaspace)，目前仍在征求意见中，可进入 [LXGW Bright Code](https://github.com/lxgw/LxgwBright-Code) 项目专页了解。
